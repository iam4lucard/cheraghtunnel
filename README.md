...
دستور زیر را به عنوان کاربر ریشه (root) در سرور ایران خود اجرا کنید تا پروژه دانلود، کامپایل و پنل تحت وب روی پورت `8000` فعال شود:

```bash
curl -sSf https://raw.githubusercontent.com/iambaradaran/cheraghtunnel/main/install.sh | bash
```

پس از پایان نصب، مشخصات ورود ادمین و رمز تصادفی تولید شده در ترمینال به شما نمایش داده خواهد شد.
