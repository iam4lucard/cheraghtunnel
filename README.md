...
تمام رابط کاربری گلس‌مورفیک (Glassmorphism)، دیتابیس بومی SQLite و ۱۲ پروتکل انتقال درون باینری نهایی جاسازی شده‌اند.
...
| ویژگی | توضیحات |
|:---:|:---|
| 🚀 **۱۲ پروتکل انتقال** | از TCP ساده تا WebRTC و Hysteria — انتخاب بهینه بر اساس شرایط شبکه |
...
<tr><td>🌶️ <b>Hysteria</b></td><td><code>hysteriamux</code></td><td>QUIC/UDP</td><td>پروتکل سرعت بالا با پهنای باند کنترل‌شده و الگوریتم Pacing مبتنی بر QUIC/UDP</td><td>شبکه‌های شدیداً محدود و نویزدار</td></tr>
</table>
