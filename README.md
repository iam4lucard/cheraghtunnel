...
* 🚀 **۱۵ پروتکل انتقال متنوع:** از TCP ساده تا لایه‌های WebRTC ،Reality ،Hysteria و پروتکل‌های خلاقانه اختصاصی مانند Oracle، Vortex و Nirvana جهت عبور از دیوارهای آتش مختلف بر اساس شرایط شبکه.
...
| 🔮 **Oracle** | `oracle` | DNS/UDP | شبیه‌سازی کوئری‌های معتبر DNS همراه با اکستنشن‌های حجم بالای EDNS0 در پورت ۵۳ | دور زدن فیلترینگ شدید UDP |
| 🌀 **Vortex** | `vortex` | Steam/UDP | شبیه‌سازی پکت‌های پینگ و کوئری سرور بازی‌های آنلاین (Source Engine CS:GO) | گیمینگ با QoS اولویت بالا |
| 🕉️ **Nirvana** | `nirvana` | HTTP/TCP | شبیه‌سازی هوشمند درخواست‌های وب POST با متد انتقال Chunked و رمزنگاری XOR | استتار کامل ترافیک TCP |
